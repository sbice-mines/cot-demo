 ...
 *
 * Perfect for presentations on AI safety, UX design, and engineering best practices.
 *
 * @author Your Name
 * @version 1.0.0
 * @created 2024
...
// Content designers can modify these to change tone, structure, presentation
// =============================================================================
...
Your expenses increased 10.2% from Q2 ($28,100) to Q3 ($30,750). Top drivers: Marketing (+11.7% to $13,400), Freight (+23.8% to $2,600), and Travel (+8.1% to $8,650). This suggests strategic marketing investments and external cost pressures rather than operational issues.`;
    ...
    const codedResponse = {
      thinking: {
        ...
        assumptions: [
          "Data represents complete expense categories",
          "No one-time charges included",
        ],
      },
      answer: {
        ...
        top_drivers: [
          {
            category: "Marketing",
            percent_change: 11.7,
            description: "Strategic campaign investments",
          },
          {
            category: "Freight",
            percent_change: 23.8,
            description: "Fuel price increases",
          },
          {
            category: "Travel",
            percent_change: 8.1,
            description: "Increased business activity",
          },
        ],
        implication:
          "Increase driven by strategic investments and external factors rather than operational inefficiencies",
      },
    };
    ...
    const metrics = {
      ...
      instructed: {
        tokens: estimateTokens(instructedResponse),
        ttft: 180,
        latency: 650,
      },
      coded: {
        tokens: estimateTokens(JSON.stringify(codedResponse)),
        ttft: 180,
        latency: 600,
      },
    };
  ...
  const callClaude = async (systemPrompt, userPrompt) => {
    ...
    if (!apiKey) {
      throw new Error(
        "Anthropic API key not found. Please add REACT_APP_ANTHROPIC_KEY to your .env file"
      );
    }
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      if (!hasApiKey) {
        ...
        setLoadingStep("Generating mock responses...");
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                    <p className="text-sm text-blue-800">
                      <strong>💡 Pro tip:</strong> Try different scenarios and
                      prompt presets to see how the same question produces
                      different responses based on user context and
                      requirements.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700 mb-3">
                    To see live AI responses, you need to add your Anthropic API
                    key.
                  </p>
                  ...
                  <p className="text-xs text-amber-600 mt-2">
                    <strong>Note:</strong> The demo will show mock responses
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-slate-500 mt-1">
              This question will be sent to all four CoT approaches for
              comparison
            </p>
          </div>
          ...
          <div className="mb-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
            ...
            <p className="text-xs text-slate-500">
              Enable presentation mode to automatically expand all thinking
              sections for demos
            </p>
          </div>
          ...
          {loading && (
            <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <div className="mt-2 text-xs text-blue-600">
                This may take 10-15 seconds as we call Claude API for each
                approach...
              </div>
            </div>
          )}
            ...
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-lg p-6 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                ...
                <div className="bg-slate-800/50 rounded p-4">
                  ...
                  <div className="space-y-2 text-slate-300 text-xs">
                    <div>Prompt-Shaped: Prompts shape presentation</div>
                    <div>
        ...
        {results && (
          <div className="mt-8 bg-gradient-to-r from-green-50 to-blue-50 border-2 border-green-300 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-white rounded-lg p-4 border border-green-200">
                  ...
                  <p className="text-sm text-slate-700">
                    ...
                    Internal reasoning exposes system logic, access controls,
                    and decision boundaries that attackers can exploit.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 border border-green-200">
                  ...
                  <p className="text-sm text-slate-700">
                    ...
                    experience without code changes. Content designers can
                    iterate independently on tone and structure.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-lg p-4 border border-green-200">
                  ...
                  <p className="text-sm text-slate-700">
                    Better responses = lower costs (fewer tokens), faster
                    delivery, and higher user satisfaction. The improvements pay
                    for themselves.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-6 p-4 bg-blue-100 rounded-lg">
              <p className="text-sm text-blue-800">
                <strong>💡 For your audience:</strong> This demo shows that AI
                response design is a cross-functional challenge requiring both
                content expertise (Model UX) and engineering rigor. The
                solutions are practical and implementable today.
              </p>
            </div>
          </div>
        )}
